...
return [
    ...
    'table_indexes' => [
        'orders_table_indexes' => [ 'payment_id' => 'string', 'store_id' => 'int', 'ship_province' => 'string', 'ship_country' => 'string',
        ...
        'fulfillment_orders_table_index' => [
            ...
            'line_items' => 'string', 'delivery_method' => 'string', 'assigned_location' => 'string', 'merchant_requests' => 'string', 'assigned_service' => 'string',
            'assigned_shipment_status' => 'string', 'assigned_status' => 'string', 'assigned_tracking_company' => 'string', 'assigned_tracking_number' => 'string',
            'assigned_tracking_numbers' => 'string'
        ]
    ],
    'one_time_payments' => [
        1 => [
